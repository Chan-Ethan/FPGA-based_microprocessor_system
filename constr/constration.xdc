...
set_property PACKAGE_PIN P3 [get_ports {LED12_9_STATE[3]}]
set_property PACKAGE_PIN U3 [get_ports {LED12_9_STATE[2]}]
set_property PACKAGE_PIN W3 [get_ports {LED12_9_STATE[1]}]
set_property PACKAGE_PIN V3 [get_ports {LED12_9_STATE[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {LED12_9_STATE[*]}]
...
connect_debug_port u_ila_0/probe3 [get_nets [list seg7_control_inst/ps2pkt_vld]]
